...
class GestionPlusInterface
{
    ...
    const TEST       = "https://office-server-paybox.test.sips-atos.com/rs-services/v2/";
    const PRODUCTION = "https://office-server.paybox.bnpparibas.net/rs-services/v2/";
    ...
    // Traitement des reponses de Paybox
    // -----------------------------------
